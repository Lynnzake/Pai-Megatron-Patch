create a run_make_pretraining_dataset_megatron_qwen3.sh like below:
```
#! /bin/bash
START_TIME=$SECONDS
...
Run the command below to preprocess training data with `.arrow`format.
```bash
bash run_make_pretraining_dataset_megatron_qwen3.sh /data/tujie/tokenized_data/data-01814-of-02266.arrow Qwen3Tokenizer text /data/tujie/Qwen3/qwen-datasets /data/tujie/qwen-ckpts/Qwen3-30B-A3B
```
